...
// 5
const famous_person = "Robert Jr";
const messsage = `${famous_person} is the Iron Man`;
console.log(messsage);

// 6
const favourite_person = "  John  ";
...
// 11
const names = ["Asim", "Aryan", "Shahid", "Aftab", "Haider"];
